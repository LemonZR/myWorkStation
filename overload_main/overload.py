...
if __name__ == "__main__":
    sep = str(os.sep)
    data_dir = BASE_DIR +sep +'Data'+sep+'overload' #sep.join([BASE_DIR,'Data','overload'])
    ...
    for i in aa.readlines():
        ...
        'coupon_info':{
        'channelId' : '60',
        'batchID' : ('1051785022945755136',),
        'prov_code' : '311'}
        }
        thread_num =5 #可选参数，默认1
        ...
        p.apply_async(func=run_me,args=(rr,))#非阻塞
    p.close()
    p.join()